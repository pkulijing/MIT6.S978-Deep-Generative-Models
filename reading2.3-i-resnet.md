...
- [1. 论文动机](#1-论文动机)
  - [1.1 从课程设计者的角度：三篇论文的递进逻辑](#11-从课程设计者的角度三篇论文的递进逻辑)
  - [1.2 Glow留下的"不完美"：维度分割的代价](#12-glow留下的不完美维度分割的代价)
  - [1.3 i-ResNet的关键创新：从ODE理论获得启发](#13-i-resnet的关键创新从ode理论获得启发)
  - [1.4 i-ResNet相比Glow的核心优势](#14-i-resnet相比glow的核心优势)
  - [1.5 三篇论文的技术进化轨迹](#15-三篇论文的技术进化轨迹)
  - [1.6 i-ResNet解决的核心问题](#16-i-resnet解决的核心问题)
- [2. 数学基础](#2-数学基础)
  - [2.1 Lipschitz常数](#21-lipschitz常数)
    - [2.1.1 定义](#211-定义)
    - [2.1.2 复合函数的Lipschitz常数](#212-复合函数的lipschitz常数)
    - [2.1.3 可微函数的快速计算方法](#213-可微函数的快速计算方法)
    - [2.1.4 神经网络激活函数的Lipschitz常数](#214-神经网络激活函数的lipschitz常数)
  - [2.2 矩阵的Lipschitz常数](#22-矩阵的lipschitz常数)
    - [2.2.1 奇异值的定义](#221-奇异值的定义)
    - [2.2.2 多维线性函数的Lipschitz常数](#222-多维线性函数的lipschitz常数)
    - [2.2.3 举例说明](#223-举例说明)
  - [2.3 Banach不动点定理](#23-banach不动点定理)
    - [2.3.1 基础定义](#231-基础定义)
    - [2.3.2 定理内容](#232-定理内容)
    - [2.3.3 定理证明](#233-定理证明)
- [3. 可逆ResNet的理论基础](#3-可逆resnet的理论基础)
...
- [5. 总结与展望](#5-总结与展望)
  - [5.1 三篇论文的递进脉络](#51-三篇论文的递进脉络)
  - [5.2 i-ResNet的影响](#52-i-resnet的影响)
  - [5.3 未来方向](#53-未来方向)
