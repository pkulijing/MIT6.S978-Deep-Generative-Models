...
- [3. 论文的主要逻辑](#3-论文的主要逻辑)
  ...
  - [3.2 训练方法](#32-训练方法)
    ...
    - [3.2.2 其他工程细节](#322-其他工程细节)
      - [3.2.2.1 梯度优化](#3221-梯度优化)
      - [3.2.2.2 正则化：Weight Decay](#3222-正则化weight-decay)
      - [3.2.2.3 网络剪枝](#3223-网络剪枝)
- [4. 总结](#4-总结)
  - [4.1 论文解决的核心问题](#41-论文解决的核心问题)
  - [4.2 与后续工作的联系](#42-与后续工作的联系)
  - [4.3 局限与未来方向](#43-局限与未来方向)
