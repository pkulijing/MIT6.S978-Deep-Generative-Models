...
- [1. 论文的动机: The Bitter Lesson](#1-论文的动机-the-bitter-lesson)
- [2. 论文的前序知识](#2-论文的前序知识)
  - [2.1 Byte Pair Encoding (BPE)](#21-byte-pair-encoding-bpe)
    - [2.1.1 BPE 算法原理](#211-bpe-算法原理)
    - [2.1.2 BPE Dropout](#212-bpe-dropout)
  - [2.2 离散随机变量的梯度估计](#22-离散随机变量的梯度估计)
    - [2.2.1 Gumbel 分布](#221-gumbel-分布)
    - [2.2.2 带温度参数的 Softmax 函数](#222-带温度参数的-softmax-函数)
  - [2.3 Transformer](#23-transformer)
    - [2.3.1 Transformer 自注意力机制](#231-transformer-自注意力机制)
    - [2.3.2 因果掩码 (Causal Masking)](#232-因果掩码-causal-masking)
    - [2.3.3 稀疏 Transformer](#233-稀疏-transformer)
- [3. 论文的主要逻辑](#3-论文的主要逻辑)
  - [3.1 整体框架：两阶段训练](#31-整体框架两阶段训练)
    - [3.1.1 概述](#311-概述)
    - [3.1.2 变分推断视角](#312-变分推断视角)
  - [3.2 训练技巧](#32-训练技巧)
  - [3.3 样本生成与 CLIP 重排序](#33-样本生成与-clip-重排序)
    - [3.3.1 自回归生成过程](#331-自回归生成过程)
    - [3.3.2 CLIP 重排序机制](#332-clip-重排序机制)
- [4. 总结](#4-总结)
  - [4.1 与动机的呼应](#41-与动机的呼应)
    - [4.1.1 规模效应的验证](#411-规模效应的验证)
    - [4.1.2 简单方法的有效性](#412-简单方法的有效性)
  - [4.2 DALL-E 的局限性与后续工作方向](#42-dalle-的局限性与后续工作方向)
    - [4.2.1 当前局限性分析](#421-当前局限性分析)
    - [4.2.2 后续工作方向](#422-后续工作方向)
    - [4.2.3 对 AI 发展的更广泛启示](#423-对-ai-发展的更广泛启示)
