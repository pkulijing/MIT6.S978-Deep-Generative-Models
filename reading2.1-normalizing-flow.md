...
- [1. 概述](#1-概述)
  - [1.1 核心思想](#11-核心思想)
  - [1.2 关键优势](#12-关键优势)
  - [1.3 变量变换公式的深层含义](#13-变量变换公式的深层含义)
    - [1.3.1 数学证明](#131-数学证明)
    - [1.3.2 几何直观理解](#132-几何直观理解)
    - [1.3.3 直观理解](#133-直观理解)
  - [1.4 与其他生成模型的对比](#14-与其他生成模型的对比)
- [2. 论文：Variational Inference with Normalizing Flows (Rezende & Mohamed, 2015)](#2-论文variational-inference-with-normalizing-flows-rezende--mohamed-2015)
  - [2.1 动机：为什么需要归一化流？](#21-动机为什么需要归一化流)
    - [2.1.1 变分推断的核心困境](#211-变分推断的核心困境)
    - [2.1.2 Mean-Field近似的致命缺陷](#212-mean-field近似的致命缺陷)
    - [2.1.3 归一化流的解决方案](#213-归一化流的解决方案)
  - [2.2 核心概念](#22-核心概念)
    - [2.2.1 变量变换的数学基础](#221-变量变换的数学基础)
    - [2.2.2 有限流（Finite Flows）](#222-有限流finite-flows)
    - [2.2.3 Planar Flow（平面流）](#223-planar-flow平面流)
    - [2.2.4 Radial Flow（径向流）](#224-radial-flow径向流)
    - [2.2.5 径向流雅可比行列式的详细推导](#225-径向流雅可比行列式的详细推导)
    - [2.2.6 直观理解：重力场类比](#226-直观理解重力场类比)
    - [2.2.7 无限小流（Infinitesimal Flows）：理论极限的力量](#227-无限小流infinitesimal-flows理论极限的力量)
    - [2.2.8 核心思想：从离散到连续](#228-核心思想从离散到连续)
    - [2.2.9 Langevin流：通往任意分布的桥梁](#229-langevin流通往任意分布的桥梁)
    - [2.2.10 Hamiltonian流：另一种视角](#2210-hamiltonian流另一种视角)
    - [2.2.11 对实践者的关键要点](#2211-对实践者的关键要点)
  - [2.3 与变分推断的结合](#23-与变分推断的结合)
    - [2.3.1 从VAE到Flow-ELBO的完整推导](#231-从vae到flow-elbo的完整推导)
    - [2.3.2 步骤1：标准VAE的ELBO](#232-步骤1标准vae的elbo)
    - [2.3.3 步骤2：引入归一化流](#233-步骤2引入归一化流)
    - [2.3.4 步骤3：展开KL散度](#234-步骤3展开kl散度)
    - [2.3.5 步骤4：关键变换 - 合并为联合概率](#235-步骤4关键变换---合并为联合概率)
    - [2.3.6 步骤5：转换到基础分布 $q_0$](#236-步骤5转换到基础分布-q_0)
    - [2.3.7 步骤6：用变量变换公式表达 $q_K$](#237-步骤6用变量变换公式表达-q_k)
    - [2.3.8 步骤7：最终的Flow-ELBO](#238-步骤7最终的flow-elbo)
    - [2.3.9 理解三项的来源](#239-理解三项的来源)
    - [2.3.10 关键要点总结](#2310-关键要点总结)
    - [2.3.11 $p(z_K)$的两种形式](#2311-pz_k的两种形式)
    - [2.3.12 摊销推断（Amortized Inference）](#2312-摊销推断amortized-inference)
  - [2.4 实验结果分析](#24-实验结果分析)
    - [2.4.1 2D合成数据的直观理解](#241-2d合成数据的直观理解)
    - [2.4.2 MNIST和CIFAR-10定量结果](#242-mnist和cifar-10定量结果)
  - [2.5 关键贡献总结](#25-关键贡献总结)
    - [2.5.1 理论贡献](#251-理论贡献)
    - [2.5.2 实践贡献](#252-实践贡献)
## 1. 概述
...
## 2. 论文：Variational Inference with Normalizing Flows (Rezende & Mohamed, 2015)
...
#### 2.2.2 有限流（Finite Flows）

![flow2.png](assets/flow2.png)

#### 2.2.3 Planar Flow（平面流）
...
#### 2.2.7 无限小流（Infinitesimal Flows）：理论极限的力量
...
#### 2.3.12 摊销推断（Amortized Inference）
